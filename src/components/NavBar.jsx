...
const NavBar = () => {
  return (
    <div
      id="nav-bar"
      className="fixed top-4 left-1/2 z-30 flex w-[calc(100%-2rem)] max-w-6xl -translate-x-1/2 flex-col items-center gap-4 rounded-lg bg-slate-900 p-4 shadow-lg md:flex-row md:flex-wrap md:justify-between md:gap-6 md:p-6"
    >
